      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-12 flex flex-col items-center">
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
             ...
             <span className="text-[10px] font-black text-blue-600 uppercase tracking-[0.4em]">User Access</span>
          </div>
          
          <h1 className="text-5xl md:text-6xl font-black text-slate-900 leading-[0.85] tracking-tight flex flex-col">
            <span className="capitalize">Welcome</span>
            <span className="italic text-blue-600 capitalize">Back.</span>
          </h1>
        </div>
        ...
        <div className="bg-white border border-slate-100 p-10 rounded-none shadow-xl relative hover:border-blue-100 transition-all duration-300">
          <form onSubmit={handleLogin} className="space-y-8">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full h-14 pl-14 pr-14 bg-slate-50 border border-slate-100 rounded-none focus:bg-white focus:border-blue-600 outline-none text-xs font-bold uppercase transition-all shadow-inner"
                  />
                  <button 
            ...
            <button 
              disabled={loading}
              className="w-full h-14 bg-slate-900 text-white font-black text-[10px] uppercase tracking-[0.3em] hover:bg-blue-600 transition-all flex items-center justify-center gap-4 disabled:opacity-50"
            >
          ...
          <div className="mt-10 pt-10 border-t border-slate-100 text-center">
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
              ...
              <Link to="/signup" className="text-blue-600 font-black hover:underline ml-2">Sign Up Now</Link>
            </p>
          </div>
        </div>
      </div>
