...
export default function TermsAndConditions() {
  ...
  ("Company," "we," "us," "our"), a company registered in Missouri, United States at 256 NE Elm St, Billings, MO 65610.
      </p>
      <p>
        We operate the website <a href="http://printerprime.shop/">http://printerprime.shop/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p>
        PrinterPrime
  ...
  is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading technology brands.
      ...
      <p>
        You can contact us by email at <a href="mailto:info@printerprime.shop">info@printerprime.shop</a>, or by mail to 256 NE Elm St, Billings, MO 65610, United States.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and PrinterPrime
  ...
  , concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@printerprime.shop">info@printerprime.shop</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://printerprime.shop/return-policy">http://printerprime.shop/return-policy</a>.</p>
      ...
      <p>We care about data privacy and security. Please review our Privacy Policy: <a href="http://printerprime.shop/privacy-policy">http://printerprime.shop/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
      ...
      <p>These Legal Terms and your use of the Services are governed by and construed in accordance with the laws of the State of Missouri applicable to agreements made and to be entirely performed within the State of Missouri, without regard to its conflict of law principles.</p>

      <h2>16. DISPUTE RESOLUTION</h2>
      <p>Any legal action of whatever nature brought by either you or us (collectively, the "Parties" and individually, a "Party") shall be commenced or prosecuted in the state and federal courts located in Missouri, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts.</p>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-2 uppercase tracking-tighter">
          ...
          <p>United States</p>
          <p className="pt-4 text-blue-600 font-black lowercase">Email: info@printerprime.shop</p>
        </address>
      </div>
    </PolicyLayout>
  );
