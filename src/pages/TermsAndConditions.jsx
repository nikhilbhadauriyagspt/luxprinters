...
export default function TermsAndConditions() {
  return (
    ...
    >
      ...
      <p>
        We are myprinterman  ("Company," "we," "us," "our"), a company registered in North Carolina, United States at 722 N West St, Raleigh, NC 27603.
      </p>
      <p>
        We operate the website <a href="http://myprinterman.com/">http://myprinterman.com/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p>
        myprinterman is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading technology brands.
      </p>
      <p>
        You can contact us by email at <a href="mailto:info@myprinterman.com">info@myprinterman.com</a>, or by mail to 722 N West St, Raleigh, NC 27603, United States.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and myprinterman , concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
      </p>
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@myprinterman.com">info@myprinterman.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://myprinterman.com/return-policy">http://myprinterman.com/return-policy</a>.</p>
      ...
      <p>Any legal action of whatever nature brought by either you or us (collectively, the "Parties" and individually, a "Party") shall be commenced or prosecuted in the state and federal courts located in North Carolina, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts.</p>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-2 uppercase tracking-tighter">
          ...
          <p>United States</p>
          <p className="pt-4 text-blue-600 font-black lowercase">Email: info@myprinterman.com</p>
        </address>
      </div>
    </PolicyLayout>
  );
